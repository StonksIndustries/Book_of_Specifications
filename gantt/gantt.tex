...
\centering
  \begin{ganttchart}[
    ...
    \ganttbar[progress=10,bar/.append style={=white}]{Design des textures}{4}{12} \\
    \ganttbar[progress=0]{Validation}{7}{9} \\
    \ganttbar[progress=0]{Integration dans godot}{9}{12} \\
    \ganttnewline
    
    % \ganttgroup{Programmation du jeu}{9}{14} \\
    \ganttbar[progress=0]{Premiers tests sur Godot}{5}{7} \\
    \ganttbar[progress=0]{Développement}{6}{13} \\
    \ganttbar[progress=0]{Réseau}{6}{13} \\
    \ganttbar[progress=0]{IA}{10}{13} \\
    \ganttbar[progress=0]{Phase de débug / corection}{14}{14} \\
    \ganttnewline
    
    % \ganttgroup{Site web}{5}{8} \\
    \ganttbar[progress=0]{Design du site web}{6}{9} \\
    \ganttbar[progress=0]{Développement}{7}{8} \\
    \ganttbar[progress=0]{Phase de débug / corection}{9}{9} \\
    \ganttnewline
    \ganttvrule[
